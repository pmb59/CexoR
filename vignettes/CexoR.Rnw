...
\date{Modified: July, 2013. Compiled: \today}
...
\item Madrigal P (in preparation) CexoR: An R/Bioconductor package to uncover high-resolution protein-DNA interactions in ChIP-exo replicates.
